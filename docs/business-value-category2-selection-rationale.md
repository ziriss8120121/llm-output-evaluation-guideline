...
| 候補 | 今回の扱い | 理由 / 対応先 |
|---|---|---|
| 目的・タスク適合 / Task Completion / Functional Appropriateness | **採用 / 統合** | 「目的達成性」へ統合。LLM機能固有の目的・期待価値への適合を扱う |
| Helpfulness | **採用 / 統合** | 単独区分にすると完全性・関連性・指示遵守等を包含しすぎるため、「目的達成性」の考え方へ統合 |
...
| 区分2 | 主な問い |
|---|---|
| **目的達成性** | 他の共通品質区分では捉えきれない、このLLM機能固有の目的・期待価値に適合しているか |
